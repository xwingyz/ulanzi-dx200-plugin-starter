...
const RENDER_STATES = {
  ...
  healthbreak: [
    { healthStatus: 'waiting', intervalRemainingMs: 1_200_000 },
    { healthStatus: 'queued', queueKind: 'due', intervalRemainingMs: 0 },
    { healthStatus: 'due', dueAt: Date.now() - 30_000, animFrame: 0 },
